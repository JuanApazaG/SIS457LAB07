...
// Cross Module References
	ARKANOID04_API UClass* Z_Construct_UClass_ABall_NoRegister();
	ARKANOID04_API UClass* Z_Construct_UClass_ABall();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABall_Statics::NewProp_SM_Ball_MetaData[] = {
		{ "Category", "Ball" },
		{ "Comment", "/*UPROPERTY(EditAnywhere)\n\x09\x09""class USceneComponent* Scene;*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Ball.h" },
	...
	IMPLEMENT_CLASS(ABall, 414223376);
	template<> ARKANOID04_API UClass* StaticClass<ABall>()
	{
		return ABall::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABall(Z_Construct_UClass_ABall, &ABall::StaticClass, TEXT("/Script/arkanoid04"), TEXT("ABall"), false, nullptr, nullptr, nullptr);
